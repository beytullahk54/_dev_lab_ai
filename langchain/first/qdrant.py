...
texts = [
    ...
    (9, "Bakan Fidan, Türkiye'nin Mısır ve Suudi Arabistan ile askeri ittifak görüşmesini doğruladı"),
    (10,  "Dışişleri Bakanı Hakan Fidan'a Türkiye'nin Suudi Arabistan ve Mısır ile yaptığı iddia edilen askeri ittifak görüşmesi soruldu. Fidan, 'Güvenlik konusunda bir işbirliğinin, bir platformun oluşturulması gerekiyor. Ve geniş bir yelpazede  ") ,
    (11, "bu platformun ortaya çıkmasından sonra, ben sorunların büyük oranda çözüleceğini düşünüyorum. Yani an itibarıyla bu görüşmeler var, konuşmalar var ama biz herhangi bir, anlaşmaya hala imza atmış değiliz. ' dedi.")
]
